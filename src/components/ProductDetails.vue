        ...
        <div class="media is-one-quarter-desktop is-half-tablet">
          <div class="content">
            ...
            <div class="block">
              ...
              <p class="title is-5">{{ product.stock }} in stock</p>
            </div>

            <div class="block buttons">
              <button class="button is-primary" @click="startEditing">Update</button>
              <button class="button is-danger" @click="removeProduct">Delete</button>
            </div>
          </div>
        </div>
      </article>
